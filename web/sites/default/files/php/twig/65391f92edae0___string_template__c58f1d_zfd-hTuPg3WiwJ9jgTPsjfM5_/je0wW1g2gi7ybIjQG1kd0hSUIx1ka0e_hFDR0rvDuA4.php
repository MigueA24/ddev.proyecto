...
class __TwigTemplate_a59f9239bd3ee5334546e9636f1123d5 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("{# inline_template_start #}<p>Payment added via <em>{{ gateway }}</em> for {{ amount|commerce_price_format }}{% if method %} using <em>{{ method }}</em>{% endif %}. State: {{ state }}.{% if remote_id %}<br /> Transaction ID: {{ remote_id }}.{% endif %}</p>", "__string_template__c58f1de0cf0328d4ec1309fbed54e20b", "");
    }
