...
class __TwigTemplate_0228654f7eddffdbd5f333bc0ea0b1d2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("{# inline_template_start #}<div class=\"col-sm-4\">
  <div class=\"single-service\">
   <div class=\"service-img\">
    <a href=\"productoporcategoria/{{ tid__value }}\">
          {{ field_tx_imagen_categoria }} 
    </a>
    </div>
\t<div class=\"service-info\">
<h3><a href=\"productoporcategoria/{{ tid__value }}\"> {{ name }} </a></h3>
<p> {{ description__value }} </p>
<p><a href=\"productoporcategoria/{{ tid__value }}\" >Ver cátalogo</a></p>
</div>
</div>
</div>
", "__string_template__cdfcbd40076966410c967b7dc9f68090", "");
